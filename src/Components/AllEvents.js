...
class AllEvents extends Component {
    ...
    renderEvent = (event) => (
        <Link to={`/event/${event.id}`} className="card" key={event.id}>
            ...
            <div className="content">
                <p><i className="icon calendar"></i>{moment(event.when).format('MM-DD-YYYY", "YYYY-MM-DD')}</p>
                <p><i className="icon clock"></i>{moment(event.when).format('MM-DD-YYYY", "YYYY-MM-DD')}</p>
